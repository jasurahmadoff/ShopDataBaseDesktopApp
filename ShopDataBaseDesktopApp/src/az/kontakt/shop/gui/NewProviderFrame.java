...
public class NewProviderFrame extends javax.swing.JFrame {

    private ProviderService providerService;
    private MainFrame mainFrame;

    public NewProviderFrame(ProviderService providerService, MainFrame mainFrame) {
        initComponents();
    ...
    private void saveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveBtnActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Provider has been successfully added!");
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, "Provider has not been successfully added!", "Error", JOptionPane.ERROR_MESSAGE);
            e.printStackTrace();
        }
